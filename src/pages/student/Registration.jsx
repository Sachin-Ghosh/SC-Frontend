...
const Registration = () => {
  ...
  useEffect(() => {
    ...
    const getTeamMembers = async () => {
      try {
        const response = await fetch(`${import.meta.env.VITE_API_URL}/api/users/filter/?department=${encodeURIComponent(formData.department)}&year=${formData.year ? formData.year:''}&division=${formData.division ? formData.department:''}&page=1&page_size=10000`, {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${accessToken}`,
          }
          ...
          <div className="flex flex-col min-h-screen items-center justify-center w-full max-w-2xl sm:max-w-full py-8 relative z-20 top-10">
            ...
            <div className='relative '>
              ...
              >
                ...
                {(event.participation_type === 'GROUP' || event.participation_type === "DUO") && (
